...
| DIC01 | 역사사전 단건 등록·수정 | ALREADY_DECIDED | 교사 callable의 요청·삭제 연결과 회수 원장을 검증하고, 편집 초안과 호출 계정을 보호합니다. W9 Draft·Gateway 기능이라고 표시하지 않습니다. | [요청 연결](../w12-history-dictionary-request-binding.md), [편집 복구](../w12-history-dictionary-editor-recovery.md), [삭제 연결](../w13-history-dictionary-delete-binding.md), Production 전 Gateway·CAS·receipt·보상 출처·배포/알림 migration |
