...
| DIC01 | 역사사전 단건 등록·수정 | ALREADY_DECIDED | 교사 callable의 요청·수정·삭제 연결과 회수 원장을 검증하고, 요청 출처를 보상 출처와 분리합니다. 편집 초안과 호출 계정을 보호하며 W9 Draft·Gateway 기능이라고 표시하지 않습니다. | [요청 연결](../w12-history-dictionary-request-binding.md), [편집 복구](../w12-history-dictionary-editor-recovery.md), [삭제 연결](../w13-history-dictionary-delete-binding.md), [수정 연결](../w14-history-dictionary-update-binding.md), [요청 출처](../w15-history-dictionary-request-origin.md), Production 전 Gateway·CAS·receipt·원래 보상 학기/원장 출처·배포/알림 migration |
