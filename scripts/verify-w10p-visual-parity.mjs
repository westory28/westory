...
const assertCapturePreTransmissionBoundarySourceOrdering = (sourceText) => {
  ...
  assert.doesNotMatch(
    ...
    "Context-close WebChannel backchannels and termination images must complete, never revoke, their request-stage authorization.",
  );
...
assert.equal(browserConnectProxyAttestation.schemaVersion, 2);
assert.deepEqual(
