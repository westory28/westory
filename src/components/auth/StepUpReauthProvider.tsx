...
const commandLabel = (commandName: string) => {
  const labels: Record<string, string> = {
    ...
    createGradeDraft: "성적 초안 생성",
    reviewGradeDraft: "성적 채점 검토",
    finalizeGradeEvidence: "성적 근거 확정",
    ...
    createSemesterCutoverPlan: "합성 학기 전환 계획 생성",
    dryRunSemesterCutover: "합성 학기 전환 드라이런",
    applySemesterCutoverBatch: "합성 operation 근거 확인",
    verifySemesterCutover: "합성 학기 전환 결과 검증",
    resumeSemesterCutover: "합성 학기 전환 미완료 항목 복구",
    createSemesterRollbackPlan: "합성 학기 전환 rollback 계획 생성",
