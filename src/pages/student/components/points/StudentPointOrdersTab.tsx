...
const StudentPointOrdersTab: React.FC<StudentPointOrdersTabProps> = ({
  orderFilter,
  orders,
  onOrderFilterChange,
}) => (
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <div className="mt-2 text-sm text-gray-500">
                  ...
                  {order.reviewedAt?.seconds
                    ? ` · \uCC98\uB9AC\uC77C ${formatPointDateTime(order.reviewedAt)}`
                    : ""}
                </div>
              </div>
              <div className="text-right">
                <div className="text-xs font-bold text-gray-400">사용 위스</div>
                <div className="text-2xl font-black text-blue-700 whitespace-nowrap">
