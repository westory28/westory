                            ...
                            <tr key={transaction.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-4 py-4">
                                    <span className="inline-flex rounded-full bg-gray-100 px-3 py-1 text-xs font-bold text-gray-700">
                                        {POINT_TRANSACTION_TYPE_LABELS[transaction.type]}
                                    </span>
                                </td>
                                ...
                                <td className="px-4 py-4 text-gray-700">{transaction.sourceLabel || POINT_TRANSACTION_TYPE_LABELS[transaction.type]}</td>
