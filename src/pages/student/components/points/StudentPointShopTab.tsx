        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
            <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                    현재 보유 위스로 요청할 수 있는 상품을 확인하고 바로 구매 요청까지 진행할 수 있습니다.
                </p>
            </div>
            <div className="text-sm font-bold text-gray-500 whitespace-nowrap">
                사용 가능 위스 <span className="text-blue-700">{formatWisAmount(wallet.balance || 0)}</span>
            </div>
        </div>
            ...
            <section className="rounded-2xl border border-blue-200 bg-blue-50 p-5">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <button
                        ...
                        className="self-start rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-xs font-bold text-gray-600 hover:bg-gray-50 whitespace-nowrap"
                    >
                        닫기
                    </button>
                </div>
