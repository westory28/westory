            ...
            <>
              <section className="bg-white border border-gray-200 rounded-2xl p-5">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span
                    className={`text-xs font-bold px-2.5 py-1 rounded-full border ${isActiveSession ? "bg-emerald-50 text-emerald-700 border-emerald-200" : "bg-gray-50 text-gray-600 border-gray-200"}`}
                  >
                    {isActiveSession
                      ? "진행 중"
                      : isPausedSession
              ...
              <section className="bg-white border border-gray-200 rounded-2xl p-5">
                ...
                {!isActiveSession && (
                  <p className="mt-2 text-sm font-bold text-gray-500">
                    {isPausedSession
                      ? "일시 정지된 주제입니다. 재개되면 제출할 수 있습니다."
                      : "종료된 주제입니다. 제출은 진행 중인 주제에서만 가능합니다."}
                  </p>
                )}
                {submitError && (
