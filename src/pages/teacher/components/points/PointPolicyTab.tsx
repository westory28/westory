            ...
            >
              <div className="grid grid-cols-1 gap-4 xl:grid-cols-3">
                <AmountField
                  ...
                  disabled={!canManage}
                  suffix={formatWisAmount(policy.attendanceDaily)}
                  onChange={(value) =>
                    onPolicyChange((prev) => ({
                      ...prev,
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-2">
                ...
                >
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <AmountField
                      ...
                      suffix={formatClaims(policy.thinkCloudMaxClaims)}
                      min={1}
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                          thinkCloudMaxClaims: Math.max(
                            1,
                            Math.round(value || 0),
                          ),
                        }))
                ...
                >
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <AmountField
                      ...
                      suffix={formatClaims(policy.mapTagMaxClaims)}
                      min={1}
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                ...
                <PolicyRuleCard
                  title={POINT_POLICY_FIELD_LABELS.historyDictionaryEnabled}
                  description={
                ...
                >
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <AmountField
                      title={POINT_POLICY_FIELD_LABELS.historyDictionaryAmount}
                      description={
                        POINT_POLICY_FIELD_HELPERS.historyDictionaryAmount
                      }
                      value={policy.historyDictionaryAmount}
                      disabled={
                        !canManage ||
                        !policy.autoRewardEnabled ||
                        !policy.historyDictionaryEnabled
                      }
                      suffix={formatWisAmount(policy.historyDictionaryAmount)}
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                          historyDictionaryAmount: value,
                        }))
                      }
                    />
                    <AmountField
                      ...
                      value={policy.historyDictionaryMaxDailyClaims}
                      disabled={
                        !canManage ||
                        !policy.autoRewardEnabled ||
                        !policy.historyDictionaryEnabled
                      ...
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                          historyDictionaryMaxDailyClaims: Math.max(
                            1,
                            Math.round(value || 0),
                          ),
                        }))
                    ...
                    <AmountField
                      ...
                      value={policy.historyDictionaryMinDefinitionLength}
                      disabled={
                        !canManage ||
                        !policy.autoRewardEnabled ||
                        !policy.historyDictionaryEnabled
                      ...
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                          historyDictionaryMinDefinitionLength: Math.max(
                            1,
                            Math.round(value || 0),
                          ),
                        }))
            ...
            >
              <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
                <AmountField
                  ...
                  disabled={!canManage}
                  suffix={formatWisAmount(policy.attendanceMonthlyBonus)}
                  onChange={(value) =>
                    onPolicyChange((prev) => ({
                      ...prev,
                ...
                <PolicyRuleCard
                  ...
                  disabled={!canManage || !policy.autoRewardEnabled}
                  summary={formatWisAmount(policy.quizBonusAmount)}
                ...
                >
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <AmountField
                      title={POINT_POLICY_FIELD_LABELS.quizBonusThreshold}
                      description={
                      ...
                      suffix={formatScoreThreshold(policy.quizBonusThreshold)}
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                    ...
                    />
                    <AmountField
                      title={POINT_POLICY_FIELD_LABELS.quizBonusAmount}
                      description={POINT_POLICY_FIELD_HELPERS.quizBonusAmount}
                      ...
                      suffix={formatWisAmount(policy.quizBonusAmount)}
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                ...
                <PolicyRuleCard
                  ...
                  disabled={!canManage || !policy.autoRewardEnabled}
                  summary={formatWisAmount(policy.historyClassroomBonusAmount)}
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <AmountField
                      ...
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                          historyClassroomBonusThreshold: value,
                        }))
                      }
                    />
                    <AmountField
                      ...
                      onChange={(value) =>
                        onPolicyChange((prev) => ({
                          ...prev,
                          historyClassroomBonusAmount: value,
                        }))
                      }
                    />
                  </div>
              ...
              <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
                <div className="rounded-lg border border-slate-200 bg-white p-4">
                  ...
                  <div className="mt-4 inline-flex rounded-md border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-bold text-slate-700">
                    현재 {policy.manualAdjustEnabled ? "허용" : "차단"}
                  </div>
                </div>
                <div className="rounded-lg border border-slate-200 bg-white p-4">
                  <div className="text-sm font-extrabold text-slate-900">
                  ...
                  <div className="mt-4 inline-flex rounded-md border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-bold text-slate-700">
                    현재 {policy.allowNegativeBalance ? "허용" : "차단"}
                  </div>
                </div>
              </div>
            </SectionPanel>
